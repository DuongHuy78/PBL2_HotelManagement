...
## Objective
- Develop and operate a complete hotel room management program, integrating multiple optimized features with practical applicability.
- Apply object-oriented programming (OOP) techniques using the C++ programming language, combined with data structures to build an efficient application.
- Implement a modern graphical user interface (UI).
